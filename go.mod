...
require (
	...
	github.com/octopus-network/beefy-go v0.6.0 // indirect
	github.com/octopus-network/trie-go v0.3.0 // indirect
...
replace github.com/cosmos/ibc-go/v6 => github.com/octopus-network/ibc-go/v6 v6.1.0-ics10.7
